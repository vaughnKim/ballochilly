					...
					<table class="table table-striped table-bordered table-hover text-muted no-text-center" style = "width:70%;">
						<tr>
							...
							<td><input type="text" name="search" placeholder="번지, 도로명을 입력해 주세요" id="search"/>
							    <input type="button" value="검색" name="searchBtn"/> </td>
						</tr>
						<tr>
							<td>검색결과</td>
						...
						<tr>
							<td>풋살장 이름</td>
							<td><input type="text" name="stadiumName" id="stadiumName"/></td>
						</tr>
						<tr>
							<td>코트</td>
						...
						<tr>
							<td>기타사진</td>
							<td><input type="file" name="file4" multiple id="file4"/></td>
						</tr>
						<tr>
							<td>시설정보</td>
							<td> <textarea name="info" cols="50" rows="5" id="info" placeholder="주차장, 샤워장, 매점 이용 가능 유무를 기입해 주세요"></textarea></td>
						</tr>
					</table>
					<div class ="no-text-center panel-heading text-muted" align="center">
						<input type="submit" id="register" value="등록" class="L_Btn"/>
						<input type="button" value="목록" onclick="location.href='./allStadiumList.do'" class="L_Btn"/>
					</div>
				</div>
			</div>
		</div>
